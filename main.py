...
def main():
    ...
    cidade_escolhida = input(
        "Digite o nome de uma cidade para ver seus vizinhos: ")
    if cidade_escolhida in grafo.vertices:
        ...
        print(
            f"Quantidade de vizinhos de {cidade_escolhida}: {quantidade_vizinhos}")
    else:
    ...
    # testando passeio turistico
    existe, passeio = grafo.passeio_turistico()
    if passeio:
        print(f"Passeio turístico encontrado:", passeio)
